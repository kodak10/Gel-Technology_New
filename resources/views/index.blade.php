...
<section class="banner-slider__wrapper banner-slider__wrapper_2 overflow-hidden">
    ...
    <div class="banner-slider_2">
        ...
        <div class="slider-item" style="background-image: linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url({{ $banner->background_image ? Storage::url($banner->background_image) : '' }}); background-size: cover; background-position: center;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
